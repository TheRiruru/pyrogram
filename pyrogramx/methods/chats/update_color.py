...
class UpdateColor:
    async def update_color(
        ...
        Parameters:
            ...
            color (:obj:`~pyrogramx.enums.ReplyColor` | :obj:`~pyrogramx.enums.ProfileColor`):
                Color type.
                Pass :obj:`~pyrogramx.enums.ReplyColor` to set reply color or
                :obj:`~pyrogramx.enums.ProfileColor` to set profile color.
