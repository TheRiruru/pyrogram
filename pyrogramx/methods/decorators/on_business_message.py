...
class OnBusinessMessage:
    def on_business_message(
        ...
        :obj:`~pyrogramx.handlers.BusinessMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramx.Client):
                self.add_handler(pyrogramx.handlers.BusinessMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramx.handlers.BusinessMessageHandler(func, self),
