...
class OnDeletedBusinessMessages:
    def on_deleted_business_messages(
        ...
        :obj:`~pyrogramx.handlers.DeletedBusinessMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramx.Client):
                self.add_handler(pyrogramx.handlers.DeletedBusinessMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramx.handlers.DeletedBusinessMessagesHandler(func, self),
