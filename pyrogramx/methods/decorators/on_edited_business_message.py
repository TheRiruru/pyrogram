...
class OnEditedBusinessMessage:
    def on_edited_business_message(
        ...
        :obj:`~pyrogramx.handlers.EditedBusinessMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramx.Client):
                self.add_handler(pyrogramx.handlers.EditedBusinessMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyrogramx.handlers.EditedBusinessMessageHandler(func, self),
