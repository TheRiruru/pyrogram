...
class Dispatcher:
    ...
    def __init__(self, client: "pyrogramx.Client"):
        ...
        async def chat_member_updated_parser(update, users, chats):
            return (
                pyrogramx.types.ChatMemberUpdated._parse(self.client, update, users, chats),
                ChatMemberUpdatedHandler
            )

        async def chat_join_request_parser(update, users, chats):
            return (
                pyrogramx.types.ChatJoinRequest._parse(self.client, update, users, chats),
                ChatJoinRequestHandler
            )

        async def story_parser(update, users, chats):
            return (
                await pyrogramx.types.Story._parse(self.client, update.story, users, chats, update.peer),
                StoryHandler
            )
