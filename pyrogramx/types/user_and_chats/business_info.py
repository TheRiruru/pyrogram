...
class BusinessInfo(Object):
    ...
    Parameters:
        ...
        greeting_message (:obj:`~pyrogramx.types.BusinessMessage`, *optional*):
            Greeting message of the business.

        away_message (:obj:`~pyrogramx.types.BusinessMessage`, *optional*):
            Away message of the business.

        working_hours (:obj:`~pyrogramx.types.BusinessWorkingHours`, *optional*):
