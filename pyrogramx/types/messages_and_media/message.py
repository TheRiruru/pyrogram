...
from pyrogramx.errors import ChannelPrivate, MessageIdsEmpty, PeerIdInvalid, ChannelPrivate, BotMethodInvalid, ChannelForumMissing
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        topic (:obj:`~pyrogramx.types.ForumTopic`, *optional*):
        ...
        reply_to_story (:obj:`~pyrogramx.types.Story`, *optional*):
        ...
        quote_entities (List of :obj:`~pyrogramx.types.MessageEntity`, *optional*):
        ...
        giveaway (:obj:`~pyrogramx.types.Giveaway`, *optional*):
            Message is a giveaway, information about the giveaway.

        story (:obj:`~pyrogramx.types.Story`, *optional*):
        ...
        forum_topic_created (:obj:`~pyrogramx.types.ForumTopicCreated`, *optional*):
            Service message: forum topic created

        forum_topic_closed (:obj:`~pyrogramx.types.ForumTopicClosed`, *optional*):
            Service message: forum topic closed

        forum_topic_reopened (:obj:`~pyrogramx.types.ForumTopicReopened`, *optional*):
            Service message: forum topic reopened

        forum_topic_edited (:obj:`~pyrogramx.types.ForumTopicEdited`, *optional*):
            Service message: forum topic edited

        general_topic_hidden (:obj:`~pyrogramx.types.GeneralTopicHidden`, *optional*):
            Service message: forum general topic hidden

        general_topic_unhidden (:obj:`~pyrogramx.types.GeneralTopicUnhidden`, *optional*):
        ...
        gift_code (:obj:`~pyrogramx.types.GiftCode`, *optional*):
            Service message: gift code information.

        requested_chats (:obj:`~pyrogramx.types.RequestedChats`, *optional*):
        ...
        raw (``pyrogramx.raw.types.Message``, *optional*):
    ...
    async def reply_text(
        ...
        Parameters:
            ...
            quote_entities (List of :obj:`~pyrogramx.types.MessageEntity`):
    ...
    async def reply_web_page(
        ...
        """Bound method *reply_web_page* of :obj:`~pyrogramx.types.Message`.
        ...
        .. code-block:: python
            ...
            await client.send_web_page(
                chat_id=message.chat.id,
                url="https://docs.pyrogramx.org"
            )

        Example:
            .. code-block:: python

                await message.reply_web_page("https://docs.pyrogramx.org")
        ...
        Returns:
            :obj:`~pyrogramx.types.Message`: On success, the sent message is returned.
        """
        if quote is None:
            quote = self.chat.type != enums.ChatType.PRIVATE
    ...
    async def click(
        ...
        Parameters:
            ...
            request_write_access (``bool``, *optional*):
                Only used in case of :obj:`~pyrogramx.types.LoginUrl` button.
            ...
            password (``str``, *optional*):
                ...
                The 2-step verification password for the current user. Only applicable, if the :obj:`~pyrogramx.types.InlineKeyboardButton` contains ``requires_password``.
        ...
        Returns:
            ...
            -   A :obj:`~pyrogramx.types.Chat` object in case of a ``KeyboardButtonUserProfile`` button.
    ...
    async def read(self) -> bool:
        """Bound method *read* of :obj:`~pyrogramx.types.Message`.
    ...
    async def view(self) -> bool:
        """Bound method *view* of :obj:`~pyrogramx.types.Message`.
