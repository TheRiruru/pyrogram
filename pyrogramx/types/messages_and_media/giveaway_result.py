...
import pyrogramx
from pyrogramx import errors, raw, utils
...
class GiveawayResult(Object):
    ...
    Parameters:
        chat (List of :obj:`~pyrogramx.types.Chat`):
        ...
        winners (List of :obj:`~pyrogramx.types.User`):
        ...
        launch_message (:obj:`~pyrogramx.types.Message`, *optional*):
