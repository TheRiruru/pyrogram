...
class ForumTopic(Object):
    ...
    Parameters:
        ...
        creator (:obj:`~pyrogramx.types.Chat`, *optional*):
            Topic creator.

        top_message (:obj:`~pyrogramx.types.Message`, *optional*):
    ...
    @staticmethod
    def _parse(client: "pyrogramx.Client", forum_topic: "raw.types.ForumTopic", messages: dict = {},  users: dict = {}, chats: dict = {}) -> "ForumTopic":
