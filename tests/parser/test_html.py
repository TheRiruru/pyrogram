...
def test_html_unparse_underline():
    ...
    text = "underline"
    entities = pyrogramx.types.List(
        [pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.UNDERLINE, offset=0, length=9)])
...
def test_html_unparse_blockquote():
    ...
    entities = pyrogramx.types.List([pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.BLOCKQUOTE, offset=0,
                                                                 length=10)])
...
def test_html_unparse_mixed():
    ...
    entities = pyrogramx.types.List(
        [pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.BOLD, offset=0, length=14),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.ITALIC, offset=7, length=7),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.UNDERLINE, offset=10, length=4),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.UNDERLINE, offset=14, length=9),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.ITALIC, offset=14, length=9),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.UNDERLINE, offset=23, length=10),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.STRIKETHROUGH, offset=30, length=3),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.STRIKETHROUGH, offset=33, length=10),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.SPOILER, offset=38, length=5),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.SPOILER, offset=43, length=10),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.CODE, offset=57, length=10)])
...
def test_html_unparse_escaped():
    ...
    text = "<b>bold</b>"
    entities = pyrogramx.types.List(
        [pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.BOLD, offset=0, length=11)])
...
def test_html_unparse_escaped_nested():
    ...
    entities = pyrogramx.types.List(
        [pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.BOLD, offset=0, length=33),
         pyrogramx.types.MessageEntity(type=pyrogramx.enums.MessageEntityType.UNDERLINE, offset=8, length=16)])
